...
function Slid() {
  ...
  return (<>
    ...
    <div className='row slider mt-0'>
      <div className='col-sm-7 ps-2  pe-1'>
        <div id="carouselExample" className="carousel slide" data-bs-ride='carousel'>
          <div className="carousel-inner">
            <div className="carousel-item active" data-bs-interval='100'>
              <img src="/images/slider2.jpg" className="d-block w-100 img-fluid sliderimg" alt="..." />
            </div>
      ...
      <div className='col-sm-5 headmarquee'>
