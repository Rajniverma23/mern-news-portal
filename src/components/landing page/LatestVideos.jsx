  ...
  return (
    <>
      ...
      <div className='row py-2 mt-4'>
         <p className='text-center bg-color text-font fs-2'> <b className='text-light text-font ' style={{fontWeight:"bold"}}>Latest Videos</b></p>
                  ...
                  <a href='#'>
                    <div className="card mx-auto  shadow-lg catcard border border-0 ">
                      ...
                      <div className="card-body">
                        <h6 className="card-title text-center textbox m-0">{item?.title}</h6>
                      </div>
                    </div>
                  </a>
                </div>
