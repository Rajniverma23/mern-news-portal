  ...
  return (
    <>
      ...
      <div className='row py-2 mt-4'>
           <p className='text-center bg-color text-font fs-2'> <b className='text-light text-font ' style={{fontWeight:"bold"}}>Image Gallery</b></p> 
            ...
            {data?.map((item) => { 
              return (<>
                <div onClick={()=>{localStorage.setItem("newsDetails",JSON.stringify(item));navigate('/news-details')}}  className='col-sm-2  mb-3'>
                  <a href='#'>
                    <div className="card mx-auto shadow-lg gx-4 border border-0 "style={{width:"180px"}}>
                      <img  height={200} src={item?.url} />
