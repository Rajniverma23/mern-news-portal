...
const Newsschema = yup
  .object()
  .shape({
    title: yup.string().required().min(2).max(70),
              ...
              <form onSubmit={handleSubmit((d) => handleAddNews(d))}>
                ...
                <div>
                  <div className="row my-3">
                    ...
                    <div className="col-9">
                      <select {...register('category')} className='form-select form-container'aria-label='Category'>
                        <option selected>Select category</option>
                        <option value="politics">politics</option>
                        <option value="education">education</option>
                        <option value="sports">History</option>
                        <option value="sports">sports</option>
                        <option value="sports">science</option>
                        <option value="sports">Business</option>
                        <option value="sports">Local</option>
                      </select>
                      {errors?.category && <p className='text-danger'>{errors?.category?.message}</p>}
                    </div>
                  </div>
                   <div className="row my-3">
                    <div className="col-3 pt-2">Place</div>
                    <div className="col-9">
                      <input type='text' {...register('city')} placeholder='Enter the Place' className='form-control'/>  
